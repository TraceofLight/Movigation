    ...
    <section class="information-container">
        ...
        <div class="score-like-button-box">
          ...
          <h2 class="movie-button">
            <v-icon id="movie-normal-button" v-if='normal' @click='movielike(), normal=false, like=true'>mdi-thumb-up-outline</v-icon>
            <v-icon id="movie-like-button" v-if='like' @click='movielike(), like=false'>mdi-thumb-up</v-icon>
          </h2>
        </div>
    </section>
